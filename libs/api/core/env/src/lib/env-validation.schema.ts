...
export const envFileValidationSchema = Joi.object({
  ...
  ACCESS_TOKEN_EXPIRES_IN_SECONDS: Joi.number().required(),
  REFRESH_TOKEN_SHORT_EXPIRES_IN_SECONDS: Joi.number().required(),
  REFRESH_TOKEN_LONG_EXPIRES_IN_SECONDS: Joi.number().required(),
});
